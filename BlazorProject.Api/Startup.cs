using BlazorProject.Api.Helper;
...
namespace BlazorProject.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BlazorProject_Api", Version = "v1" });
        ...
        {
            StripeConfiguration.ApiKey = Configuration.GetSection("StripeSettings")["ApiKey"];

            if (env.IsDevelopment())
            {
                app.UseDeveloperExceptionPage();
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BlazorProject_Api v1"));
            }
